...
$post_type_registrations = new SSM_Product_Rentals_Registrations;

// Instantiate main plugin file, so activation callback does not need to be static.
$post_type = new SSM_Product_Rentals( $post_type_registrations );
...
// $post_type_metaboxes = new SSM_Product_Rentals_Metaboxes;
...
if ( is_admin() ) {
	...
	$post_type_admin = new SSM_Product_Rentals_Admin( $post_type_registrations );
